module.exports =function toReadable(num){
    ...
    const mediumNumbers = ['ten','eleven','twelve','thirteen','fourteen','fifteen','sixteen','seventeen','eighteen','nineteen'];
    const decades =['twenty','thirty','forty','fifty','sixty','seventy','eighty','ninety'];
      ...
      return units[number[0]];
        ...
        if(number[1]==='0'){
          ...
          num>=100 && num<110||num>=200 && num<210
        ||num>=300 && num<310||num>=400 && num<410
        ||num>=500 && num<510||num>=600 && num<610
        ||num>=700 && num<710||num>=800 && num<810
        ||num>=900 && num<910){
       number = num.toString().split('');
        ...
        num>=110 && num<120 || num>=210 && num<220||
        num>=310 && num<320 ||num>=410 && num<420 ||
        num>=510 && num<520 ||num>=610 && num<620 ||
        num>=710 && num<720 ||num>=810 && num<820 ||
        num>=910 && num<920){
          number = num.toString().split('');
      ...
      return units[number[0]]+ ' hundred '+decades[number[1]-2]+' '+units[number[2]];
    }
}
